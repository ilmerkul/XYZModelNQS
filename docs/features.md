...
* Учет симметрии
  ...
  - Из симметрии можно выяснить какие корреляции должны быть равны между собой или равны друг другу, это можно добавить дополнительно к обучению через минимизацию энергии netket, что даст дополнительный обучающий сигнал.
...
* При вращении гамильтониана характер обучения меняется - для каждой нейронной сети соответсвуют какой-то базис гамильтониана, который способствует лучшей сходимости. Это связанно с оценками локальной энергии в netket (для более плотных представлений матриц гамильтонианов проще набрать ненулевых значений, на которых модель будет обучаться) и особенностями конкретной архитектуры нейронной сети. Возможно имеет смысл попробовать обучить некоторую нейронную сеть на сложном гамильтониане с большим количеством ненулевых значений в матрице гамильтониана, а затем перенести веса на более простые и дообучить, это может помочь модели поймать сложные зависимости на более информативном гамильтониане, а затем занулить некоторые части, которые перестают давать вклад. 
